...
public class MpGenerator {
    ...
    //数据库连接url
    private static String dbUrl = "jdbc:mysql://127.0.0.1:3307/test?useUnicode=true&characterEncoding=utf8";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.gua.guashard.modules.user");
        pc.setEntity("entity");
        pc.setMapper("mapper");
